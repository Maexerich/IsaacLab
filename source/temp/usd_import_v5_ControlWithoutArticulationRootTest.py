...
# Will robot be controllable without an articulation root?
...
def instantiate_Articulation() -> Articulation:
    ...
    BOX_CFG = ArticulationCfg(
        prim_path="/World/Robot_01/Body_Frame", # Must point to articulation root
        spawn=None,
        init_state=ArticulationCfg.InitialStateCfg(
            # pos=(0, 0, 2.5),
            joint_pos={"TailJoint": 0.3}, # DO NOT ADD FULL PATH: /World/Robot2/.... ADD ONLY JOINT NAME!
...
def run_simulation(sim: SimulationContext, total_time: float, step_size: float, articulation: Articulation):
    articulation_view = ArticulationView(prim_paths_expr="/World/Robot/Body") # TODO: Hard coded
